    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/services", "/api/services/**").authenticated()
                ...
                .requestMatchers(HttpMethod.POST, "/api/availability/business-hours").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/availability/block-time").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/availability/blocked-times").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/api/availability/blocked-times/**").authenticated()
