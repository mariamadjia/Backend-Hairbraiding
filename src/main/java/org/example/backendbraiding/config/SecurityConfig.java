    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/time-slots/**").authenticated()
                .requestMatchers(HttpMethod.PATCH, "/api/time-slots/**").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/api/time-slots/**").authenticated()
